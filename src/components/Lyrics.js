...
import {Text, StyleSheet, ScrollView, View, StatusBar, BackHandler} from 'react-native';
...
function Lyrics({navigation, route}) {
  ...
  const {songHeaderTitle, songLyricsStyle, songLyrics, songHeaderTitleStyle} = route.params;
  ...
  return (
    <SafeAreaView style={{backgroundColor: colors.background, flex: 1}}>
      <ScrollView style={mainContainer} showsVerticalScrollIndicator={false}>
        ...
        <Header themeColor={colors.second_font} style={songHeaderTitleStyle} title={songHeaderTitle} pressEvent={() => navigation.goBack()}/>
